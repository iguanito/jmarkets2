...
public final class SaveExpLoginAction extends JMarketsAction {
     ...
     */
    private static Log log = LogFactory.getLog(SaveExpLoginAction.class);
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        int expId = ControlServ.dbw.getClientIdByEmailAndPassword(email, password, JMConstants.EXPERIMENTER_ROLE);
        
        if(expId < 0) {
            ActionMessages errors = new ActionMessages();
            errors.add(ActionMessages.GLOBAL_MESSAGE, new ActionMessage("error.exp.notRegistered"));
