 ...
 */
public class CrossMarketNonLinearPayoffFunction implements PayoffFunction {
    
    /** Creates a new instance of StockBondPayoffFunction */
    public CrossMarketNonLinearPayoffFunction() {
    ...
    public static final String Fn_Name = "Multi-Market Non-linear";
}
