...
public class PeriodGroup {
    ...
    private String name; 
    private BankruptcyFunction bankruptcyFn; 
    private PayoffFunction payoffFn; 
    
    private double bankruptcyCutoff; 
    private boolean addCash; 
    
    private List <PeriodGroupMarketRule> marketRules; 
    private List <Trader> traders; 
    
    /** Creates a new instance of PeriodGroup */
    public PeriodGroup() {
    }
