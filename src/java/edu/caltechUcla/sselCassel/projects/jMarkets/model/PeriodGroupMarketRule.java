 ...
 */
public class PeriodGroupMarketRule {
    
    private int periodGroupId; 
    private int periodMarketId; 
    
    private String marketRole; 
    private int shortsaleConstraint; 
    private boolean addSurplus; 
    private boolean addDividend; 
    
    /** Creates a new instance of PeriodGroupMarketRule */
    public PeriodGroupMarketRule() {
    }
